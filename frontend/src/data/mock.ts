...
const ALL_FEED: FeedEvent[] = [
  ...
  },
  {
    id: 'f6',
    time: '13:45:06',
    title: '₹41,015 recovered',
    detail: 'TXN_0285 settled after bounded retry for network_timeout.',
    tone: 'ok',
    appearFrom: 'recovering',
  },
  {
...
const ALL_AUDIT: AuditEvent[] = [
  ...
  },
  {
    ...
    actor: 'policy',
    event: 'ALLOWED',
    details: 'Transient timeout · eligible for bounded retry',
    appearFrom: 'recovering',
  },
  {
    id: 'a8',
